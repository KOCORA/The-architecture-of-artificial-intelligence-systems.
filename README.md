...
На рисунке 1 показана диаграмма компонентов, описывающая структуру нашей системы.
![](https://github.com/KOCORA/The-architecture-of-artificial-intelligence-systems./blob/master/Component%20diagram.png).
...
На рисунке 2 показана диаграмма связи нашей системы.
![](https://github.com/KOCORA/The-architecture-of-artificial-intelligence-systems./blob/master/Communication%20diagram.png).
...
На рисунке 3 показана диаграмма деятельности нашей системы.
![](https://github.com/KOCORA/The-architecture-of-artificial-intelligence-systems./blob/master/Activity%20diagram.png).
